...
public class sCamera extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_s_camera);

        //Setting the header and footer....
        header = new LST(sCamera.this);
        footer = new LST(sCamera.this);
